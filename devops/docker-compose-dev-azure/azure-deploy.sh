...
resourcename="iamaduck"  # lower case, only
resourcegroup="iamaduck_rg"
...
# git clone https://github.com/apilogicserver/iamaduck.git
# cd iamaduck
...
az group create --name iamaduck_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group iamaduck_rg --sku S1 --is-linux
az container create --resource-group iamaduck_rg --name iamaduck --image apilogicserver/iamaduck:latest --dns-name-label iamaduck --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//iamaduck.westus.azurecontainer.io:5656'
